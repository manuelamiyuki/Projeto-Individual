...
function listar(idUsuario) {
    ...
    var instrucaoSql = `
    SELECT qtd_respostas_erradas,qtd_respostas_certas,data_quiz,fkUsuarios,u.nome from quiz q inner join usuarios u on q.fkUsuarios = u.id  WHERE fkUsuarios = '${idUsuario}' order by data_quiz desc limit 1;
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
